...
public class SymbDesc {
	...
	/** Nivo vidnosti. */
	private static final HashMap<AbsTree, Integer> SCOPE = new HashMap<AbsTree, Integer>();
	...
	/** Definicija imena. */
	private static final HashMap<AbsTree, AbsDef> NAMEDEF = new HashMap<AbsTree, AbsDef>();
	...
	private static final HashMap<AbsTree, SemType> TYPE = new HashMap<AbsTree, SemType>();
