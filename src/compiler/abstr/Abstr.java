...
public class Abstr implements Visitor {
	...
	public void visit(AbsFunDef funDef) {
            //Im skipping intergraded function in dump file
                if (funDef.name.equals("getInt") || funDef.name.equals("putInt") || funDef.name.equals("getString") || funDef.name.equals("putString"))
                    return;
