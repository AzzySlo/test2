...
public class FrmDesc {
	...
	/** Klicni zapisi. */
	private static final HashMap<AbsFunDef, FrmFrame> FRAMES = new HashMap<AbsFunDef, FrmFrame>();
	...
	/** Opisi dostopa. */
	private static final HashMap<AbsDef, FrmAccess> ACCESS = new HashMap<AbsDef, FrmAccess>();
